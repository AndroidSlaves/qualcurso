...
public class Book extends Bean {
	 ...
	 *
	 * @return the book unique identifier.
	 *
	 */
	 ...
	 *
	 * @return the number of collections of this book.
	 *
	 */
	 ...
	 *
	 * @return the number of entries of the same book.
	 *
	 */
	 ...
	 *
	 * @return the result of the database, indicating if the saving was successful.
	 *
	 * @throws SQLException there maybe a problem saving book in the database.
	 *
	 */
	 ...
	 *
	 * @return the book identified by the id parameter.
	 *
	 * @throws SQLException there maybe a problem getting book from database.
	 */
	 ...
	 *
	 * @return the array of book with all books in the database.
	 *
	 * @throws SQLException there maybe a problem getting books from database.
	 */
	 ...
	 *
	 * @throws SQLException there maybe a problem accessing database.
	 */
	 ...
	 *
	 * @return the first book in the database.
	 *
	 * @throws SQLException there maybe a problem accessing database.
	 */
     ...
     *
     * @return the result of the database operation, if it returned successful.
     *
     * @throws SQLException there maybe a problem accessing database.
     */
     ...
     *
     * @return the result returned from the database, if it was successfully deleted.
     *
     * @throws SQLException there maybe a problem accessing database.
     */
     ...
     *
     * @return the value inside the specified field (variable).
     *
     */
	@Override
